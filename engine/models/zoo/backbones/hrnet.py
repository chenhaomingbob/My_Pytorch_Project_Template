...
from engine.layers import Interpolate, BasicBlock, Bottleneck
...
class HRNet(nn.Module):
    ...
    def __init__(self, cfg, is_train=None, use_deconv=False, use_prediction=False, **kwargs):
    ...
    def forward(self, x):
        ...
        if self.use_deconv or self.use_prediction:
            ...
            return rough_pose_heatmaps, feature
...
class HRNetPlus(nn.Module):
    ...
    def forward(self, x, **kwargs):
        similar = kwargs.get("similar", False)
