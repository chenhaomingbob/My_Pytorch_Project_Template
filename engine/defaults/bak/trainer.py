...
from engine.defaults.base import BaseExecutor
from engine.defaults.checkpoints import get_latest_checkpoint, save_checkpoint, resume
...
class DefaultTrainer(BaseExecutor):
    ...
    def __init__(self, cfg, output_folders, phase, **kwargs):
